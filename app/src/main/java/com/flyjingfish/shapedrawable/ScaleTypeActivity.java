...
public class ScaleTypeActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        itemData = "https://pics4.baidu.coms/feed/50da81cb39dbb6fd95aa0c599b8d0d1e962b3708.jpeg?token=bf17224f51a6f4bb389e787f9c487940";
        setData();
    ...
    private void setData() {
        MyImageLoader.getInstance().loadRoundCorner(binding.ivCenter, itemData,20, R.mipmap.img_load_placeholder, R.mipmap.img_load_placeholder);
        MyImageLoader.getInstance().loadCircle(binding.ivCenterCrop, itemData, R.mipmap.img_load_placeholder, R.mipmap.img_load_placeholder);
        ...
        MyImageLoader.getInstance().loadRoundCorner(binding.ivFitStart, itemData,20, R.mipmap.img_load_placeholder, R.mipmap.img_load_placeholder);
        MyImageLoader.getInstance().loadRoundCorner(binding.ivFitCenter, itemData,20, R.mipmap.img_load_placeholder, R.mipmap.img_load_placeholder);
        MyImageLoader.getInstance().loadCircle(binding.ivFitEnd, itemData, R.mipmap.img_load_placeholder, R.mipmap.img_load_placeholder);
    }
